...
## target sources
VLOG_SRC = $(shell find ./ip_core/ -type f \( -iname \*.v -o -iname \*.sv \))
VHDL_SRC = $(shell find ./ip_core/ -type f \( -iname \*.vhd -o -iname \*.vhdl \))
...
$(TOP).txt: net/$(TOP)_synth.json ip_core/$(TOP).ccf
