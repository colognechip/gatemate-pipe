...
module LTSSM_logic_tb();
    ...
    initial begin
        ...
        $display("---------------------------------------------");
        receive_TS1(100, 8'hF7, 8'hF7); // Move to POLLING_CONFIG
        #(CLK_PERIOD * 3000);
        $display("---------------------------------------------");
        $display("Power state: %b", o_PowerDown);
        $display("FSM State: %b", uut.fsm_state);
        ...
        $display("---------------------------------------------");
        receive_TS1(200, 8'h01, 8'h02); // Move to CONFIG_COMPLETE
        #(CLK_PERIOD * 1000);
        $display("---------------------------------------------");
        $display("Power state: %b", o_PowerDown);
        $display("FSM State: %b", uut.fsm_state);
        ...
        $display("---------------------------------------------");
        receive_TS2(100, 8'h01, 8'h02); // Move to CONFIG_IDLE
        #(CLK_PERIOD * 100);
        $display("---------------------------------------------");
        $display("Power state: %b", o_PowerDown);
        $display("FSM State: %b", uut.fsm_state);
        ...
        $display("---------------------------------------------");
        receive_IDLE(200); // Need to disable Scrambling for this to work
        $display("---------------------------------------------");
        $display("Power state: %b", o_PowerDown);
        $display("FSM State: %b", uut.fsm_state);
        $display("Tx Data: %b", o_TxData);
