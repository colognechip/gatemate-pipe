...
module ccfpga_pipe_wrapper #(
   ...
   parameter  [9:0] ALIGN_COMMA_ENABLE       = 10'b1111111111; // (Default = 3FF) : Maske
   ...
   parameter        RX_RESET_DONE_GATE       = 0;
   ...
   CC_SERDES #(
      ...
      .PLL_CLK_O(clk_core_pll),
      // LOOPBACK
      .LOOPBACK_I(loopback),
      // RESET
      .TX_RESET_I(i_trx_rst),
      .RX_RESET_I(rx_reset),
